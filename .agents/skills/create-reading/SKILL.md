...
2. **Fetch Book Metadata & Summary via Wikipedia REST API**:
...
Before writing the final file, present the extracted metadata and prefilled summary to the user:

1. **Present Proposed Metadata & Summary**:
   - Show a clear summary of the proposed frontmatter values (`title`, `subtitle`, `date`, `description`, `tags`).
